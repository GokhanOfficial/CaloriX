  ...
  return (
    <Card className="border-none bg-card shadow-lg">
      <CardHeader className="pb-2">
        <CardTitle className="text-lg font-semibold">Günlük Özet</CardTitle>
      </CardHeader>
        ...
        <div className="flex flex-col items-center gap-4">
          <div className="relative">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              ...
              <span className="text-sm text-muted-foreground">kalan kcal</span>
            </div>
          </div>
          <div className="flex items-center gap-6 text-sm">
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground">Tüketilen</p>
            </div>
          </div>
        </div>
